...
void
pline(const char * line, ...) { va_list the_args;
...
/*VARARGS1*/
void
Norep(const char * line, ...) { va_list the_args;
	va_start(the_args, line);
	no_repeat = TRUE;
	vpline(line, the_args);
	no_repeat = FALSE;
...
/*VARARGS1*/
void
You(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
Your(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
You_feel(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
You_cant(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
pline_The(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
There(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
...
/*VARARGS1*/
void
You_hear(const char * line, ...) { va_list the_args;
	char *tmp;
	va_start(the_args, line);
	if (Underwater)
...
/*VARARGS1*/
void
verbalize(const char * line, ...) { va_list the_args;
	char *tmp;
...
void
raw_printf(const char * line, ...) { va_list the_args;
	va_start(the_args, line);
...
/*VARARGS1*/
void
impossible(const char * s, ...) { va_list the_args;
	va_start(the_args, s);
